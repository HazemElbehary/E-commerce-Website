...
export class CheckoutPaymentComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    this.stripe = Stripe('pk_test_51QRGx4Ix96qV5CyTRfIopAUd5tLCyHcpDYVWMugNZjKZykoGPVs3GGGooa7GGXGGxz1DhBoJFZzFckL6D3cHcLiC00HNDro92T');
  ...
  private async createOrder(basket: IBasket) {
    ...
    return this.checkoutService.createOrder(orderToCreate).toPromise(); // Error
  }
