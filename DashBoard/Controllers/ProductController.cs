...
namespace DashBoard.Controllers
{
    ...
    public class ProductController(IServiceManager serviceManager) : Controller
    {
        ...
        {
            var Originalproduct = await serviceManager.ProductService.GetProductAsync(model.Id); 

            if(Originalproduct.PictureUrl != model.PictureUrl)
            {
				await FileIOHelper.UploadAsync(model.Picture, "images/products");
				await FileIOHelper.Delete(Originalproduct.PictureUrl!);
            }
        ...
        {
            await FileIOHelper.Delete(model.PictureUrl);
